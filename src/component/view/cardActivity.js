...
export default function CardActivity(props) {
  const {
  // {title, checkActivity,
    setClickItemList,clickItemList,checkToDo, 
    index, item,idDetail, setIdDetail,toDetail,
    // toDetail,
    handleDeleteList,list,setLempar, lempar,} = props
  const navigate = useNavigate();

  console.log("idDetailidDetailidDetail",idDetail )
...
//   const checkActivity =() =>{
//     if ( checkToDo.todo_items?.length > 0) {
//       // setClick(true)
// console.log("true ++++++++")
//     } else {
//       // setClickItemList(true)
